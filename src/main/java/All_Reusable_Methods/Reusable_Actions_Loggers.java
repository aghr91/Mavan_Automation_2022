...
public class Reusable_Actions_Loggers {
    ...
    public static void dropDownMenu (WebDriver driver, String locator,ExtentTest logger, String dropDownOption, String elementName){
...
}//end of reusable actions loggers
